...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('stats')->namespace('Stats')->group(function () {
        ...
        Route::get('graphs/users', 'GraphController@users')->name('stats.graph.users');
        Route::get('graphs/users/origins', 'GraphController@origins')->name('stats.graph.users.origins');
    });
});
